_LANG = {
	...
	GAME_NAME: "Metor Miner",
	
	//AIzaSyANLRK21lGUK4jPiSuxGDw4nK5QXj4F0vE
	/*LANGUAGE INFO START HERE*/
	LANGUAGE: 'US-English',
	/*LANGUAGE INFO END HERE*/
	...
	MUST_UNLOCK_TOOL: "You must unlock this tool from your Upgrades first.",
	...
	CLOSED: 'CLOSED',
	START: 'Start',
	/*ONE OFF UI WORDS ETC START HERE*/
	...
	/*STAFF NAMES START HERE*/
	WORKMAN: 'Workman',
	RECEPTIONIST: 'Receptionist',
	CHEF: 'Chef',
	MAID: 'Maid',
	BELLBOY: 'Bell boy',
	/*STAFF NAMES END HERE*/
	...
	M3: 'Control who gets to do what, and when.',
	...
	/* UPGRADES NUMBERS DO NOT MEAN ANYTHING */
	...
	/* CHALLENGES NUMBERS DO NOT MEAN ANYTHING  */
	C1: 'Tutorial: Learn how to play the game!',
	C2: 'Normal mode, start from scratch!',
	C3: 'Easier mode, if you struggle in normal or tutorial!',
	C4: 'Sandbox mode',
	C5: 'Nightmare mode',
	C6: '',
	C7: '',
	...
	C1_DESC: 'Get used to the game',
	C2_DESC: 'Play the full game on its intended difficulty',
	C3_DESC: 'Play the full game starting with more cash',
	C4_DESC: 'Start with loads of cash. No challenge at all',
	C5_DESC: 'An open arcade with bad problems!',
	C6_DESC: '',
	C7_DESC: '',
	C8_DESC: '',
	C9_DESC: '',
	...
	/* TUTORIAL MESSAGES  NUMBERS DO NOT MEAN ANYTHING */

	TUT1: 'Welcome to Arcade Builder! Your arcade is shut right now but we will open it after adding furniture!',
	TUT2: 'You can move the camera by holding RIGHT CLICK',
	TUT3: 'Lets start by building a change machine. Click here to open up the machine building menu',
	TUT4: 'Click the icon here to select the change machine',
	TUT5: 'Place the furniture anywhere inside your arcade, if you need to move the camera you can hold RIGHT CLICK. You can also ROTATE using R',
	...
	TUT11: 'You will often have more tasks to complete. You can find them by clicking here',
	TUT12: 'Since you already placed a change machine, you can complete the first task! Click here to hand it in for a reward',
	TUT13: 'Now we can open the Arcade and get some customers. Click here to close this menu',
	TUT14: 'Click the arcade sign to open your arcade',
